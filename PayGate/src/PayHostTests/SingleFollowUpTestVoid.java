 ...
 */
public class SingleFollowUpTestVoid extends javax.swing.JFrame {

    private String requestBody;
    private final String bigTitle = "SingleFollowUp";
    private final String title = "Void";

    /**
     * Creates new form SingleFollowUpTestQuery
     */
    public SingleFollowUpTestVoid() {
        initComponents();
    ...
    private void initComponents() {
        ...
        transactionType = new javax.swing.JTextField();
        ...
        transactionID.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        transactionType.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        transactionType.setForeground(new java.awt.Color(0, 0, 153));
        transactionType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                transactionTypeActionPerformed(evt);
            }
        });
        transactionType.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                transactionTypeKeyTyped(evt);
            }
        });
        getContentPane().add(transactionType, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 280, 30));
    ...
    private void transactionIDKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_transactionIDKeyTyped
        // TODO add your handling code here:
        display();
    }//GEN-LAST:event_transactionIDKeyTyped
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        try {
            ...
            params.setProperty("transactionType", transactionType.getText());
            String res = sfu.voidOp(params);
    ...
    private void transactionTypeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_transactionTypeKeyTyped
        // TODO add your handling code here:
        display();
    }//GEN-LAST:event_transactionTypeKeyTyped
    ...
    private void display() {
        ...
        String body = "<ns1:SingleFollowUpRequest>\n"
                ...
                + "		<ns1:TransactionType>" + transactionType.getText() + "</ns1:TransactionType>\n"
                + "	</ns1:VoidRequest>\n"
    ...
    private void reset() {
        // TODO add your handling code here:
        MyObject m = new Mockups().singleFollowUpVoid();
        ...
        String body = "<ns1:SingleFollowUpRequest>\n"
                ...
                + "		<ns1:TransactionType>" + m.getProperty("transactionType") + "</ns1:TransactionType>\n"
                + "	</ns1:VoidRequest>\n"
                + "</ns1:SingleFollowUpRequest>\n";
        ...
        transactionType.setText((String) m.getProperty("transactionType"));
        requestArea.setText(body);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SingleFollowUpTestVoid().setVisible(true);
        });
    }
    ...
    private javax.swing.JTextField transactionType;
