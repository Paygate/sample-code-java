 ...
 */
public class VaultTestLookup extends javax.swing.JFrame {

    private String requestBody;
    private final String bigTitle = "Single Vault";
    private final String title = "Lookup";

    /**
     * Creates new form SingleFollowUpTestQuery
     */
    public VaultTestLookup() {
        initComponents();
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        try {
            ...
            String res = sv.lookupVault(params);
    ...
    private void reset() {
        // TODO add your handling code here:
        MyObject m = new Mockups().singleVaultLookup();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VaultTestLookup().setVisible(true);
        });
    }
